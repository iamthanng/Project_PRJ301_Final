 ...
 * @author ADMIN
 */
public class AssignCommitteeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case "editCommittee":{
                int teacher1Old = Integer.parseInt(request.getParameter("teacherOld1"));
                int teacher2Old = Integer.parseInt(request.getParameter("teacherOld2"));
                int teacher3Old = Integer.parseInt(request.getParameter("teacherOld3"));
                ...
                cdDAO.editMember(teacher1_id, teacher1Old, committeeId);
                cdDAO.editMember(teacher2_id, teacher2Old, committeeId);
                cdDAO.editMember(teacher3_id, teacher3Old, committeeId);
                break;
            }
